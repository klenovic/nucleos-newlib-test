...
char *file[] = {"f0",  "f1",  "f2",  "f3",  "f4",  "f5",  "f6",  "f7",  "f8",  "f9",
		"f10", "f11", "f12", "f13", "f14", "f15", "f16", "f17", "f18", "f19",
		"f20", "f21", "f22", "f23", "f24", "f25", "f26", "f27", "f28", "f29",
		"f30", "f31", "f32", "f33", "f34", "f35", "f36", "f37", "f38", "f39",
		"f40", "f41", "f42", "f43", "f44", "f45", "f46", "f47", "f48", "f49",
		"f50", "f51", "f52", "f53", "---", "--x", "-w-", "-wx", "r--", "r-x",
		"rw-", "rwx",
		"d---", "d--x", "d-w-", "d-wx", "dr--", "dr-x", "drw-", "drwx"};

char *fnames[] = {"---", "--x", "-w-", "-wx", "r--", "r-x", "rw-", "rwx"};

char *dir[] = {"d---", "d--x", "d-w-", "d-wx", "dr--", "dr-x", "drw-", "drwx"};
...
void test11(void);
void comp_stats(struct stat *stbf1, struct stat *stbf2);
void comp_inodes(int m, int m1);
void e(char *string);
void nlcr(void);
void str(char *s);
