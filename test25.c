...
#define BUF_SIZE 1024
  ...
  /* @nucleos: This is somehow really need otherwise e(109) may happen :/.
               Strange for me, gcc maybe? */
...
#define CHECK_STAT_WITH_MEMCMP
  ...
  if (memcmp(&st1, &st2, sizeof(struct stat)) != 0) e(109);
	...
	if (st1.st_gid != st2.st_gid) e(1093);
	if (st1.st_mode != st2.st_mode) e(1094);
	if (st1.st_size != st2.st_size) e(1095);
	if (st1.st_nlink != st2.st_nlink) e(1096);
	if (st1.st_blksize != st2.st_blksize) e(1097);
	if (st1.st_blocks != st2.st_blocks) e(1098);
	if (st1.st_mtime != st2.st_mtime) e(1099);
	if (st1.st_ctime != st2.st_ctime) e(1100);
	if (st1.st_atime != st2.st_atime) e(1101);
#endif /* CHECK_STAT_WITH_MEMCMP */
